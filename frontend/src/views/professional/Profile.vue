            ...
            <form v-else @submit.prevent="updateProfile">
              ...
              <div class="mb-3">
                ...
                <select
                  class="form-select"
                  id="service"
                  v-model="profileForm.service_id"
                  required
                >
              ...
              <h5 class="mb-3 mt-4">Location Information</h5>
              <div class="mb-3">
      ...
      try {
        ...
        if (result.success) {
          ...
          if (result.user.professional) {
            profileForm.value.service_id = result.user.professional.service_id;
            profileForm.value.experience_years = result.user.professional.experience_years;
            profileForm.value.bio = result.user.professional.bio;
            profileForm.value.location = result.user.professional.location;
            profileForm.value.pincode = result.user.professional.pincode;
          }
        }
      } catch (err) {
    ...
    const updateProfile = async () => {
      ...
      try {
        ...
        const profileData = {
          ...
          service_id: profileForm.value.service_id,
